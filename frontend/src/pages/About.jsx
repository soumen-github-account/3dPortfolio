...
const About = () => {
 ...
 const tl = gsap.timeline({
  ...
  return (
    <>
      <Helmet>
        <title>About Soumen Das | MERN Stack Developer</title>
        <meta
          name="description"
          content="Learn about Soumen Das, a MERN Stack Developer skilled in React, Node.js, and full-stack web development with modern UI/UX design."
        />
        <meta
          name="keywords"
          content="About Soumen Das, MERN Developer, React Developer, Full Stack Developer India"
        />
        <link rel="canonical" href="https://portfolio-soumen-dev.netlify.app/#about" />
      </Helmet>
